...
export const CoursesPage = () => {
  ...
  return (
    <div className={`
      ...
      ${isNavigating ? 'opacity-0 -translate-x-full' : ''}
    `}>
      {/* Background Images */}
      ...
      `}>
        {/* Header */}
        <div className="text-center mb-12 transition-all duration-500 delay-100">
            ...
            >
              <Card 
                className={`
                  ...
                  active:scale-95 hover:shadow-lg border-2
