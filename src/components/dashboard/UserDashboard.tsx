    ...
    <div className={`min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 relative overflow-hidden transition-opacity duration-300 ${isLoggingOut ? 'opacity-50' : 'opacity-100'}`}>
            ...
            <div className="flex items-center space-x-4 md:space-x-6">
              ...
              <div className="flex items-center space-x-3 transform transition-all duration-300 hover:scale-105">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm md:text-base font-medium text-gray-900 transition-colors duration-300">
                    {user?.user_metadata?.username || 'User'}
                  </p>
                  <p className="text-xs md:text-sm text-gray-500 transition-colors duration-300">
                    {user?.email}
                  </p>
                </div>
              </div>
      ...
      <main className={`container mx-auto px-4 py-16 relative z-10 transition-transform duration-500 ${isNavigating ? 'translate-x-full opacity-0' : 'translate-x-0 opacity-100'}`}>
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          {/* Courses Card */}
          <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:rotate-1 border-2 border-transparent hover:border-purple-600 bg-white/90 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-3xl bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent font-bold transition-transform duration-300 group-hover:scale-105">
                Courses
              </CardTitle>
