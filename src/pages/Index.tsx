        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <AnimatedSection key={index} animation="fade-up" delay={300 + index * 200}>
                <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-2 hover:border-[#00AEEF]">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <AnimatedSection key={index} animation="zoom-in" delay={400 + index * 200}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <AnimatedSection key={index} animation="fade-up" delay={300 + index * 200}>
                <Card className="group hover:shadow-lg transition-all duration-300 hover:border-[#00AEEF] border-2">
                  <div className="relative overflow-hidden">
                    <img 
                      src={article.image} 
                      alt={article.title}
