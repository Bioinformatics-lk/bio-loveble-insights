      ...
      <section className="py-24 md:py-32 bg-gradient-to-br from-[#54366B] via-[#363B6B] to-[#000A33] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div key={index} className="relative">
                      ...
                      >
                        <button
                          ...
                          className="w-full px-8 py-6 md:px-10 md:py-8 flex items-center justify-between text-left hover:bg-white/5 transition-all duration-150"
                        >
                          ...
                          <motion.div
                            ...
                            className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-150"
                          >
                            <svg 
          ...
          <div className="text-center">
            ...
            <p className="text-[#EAE3F5]/70 text-sm md:text-base mt-4">
